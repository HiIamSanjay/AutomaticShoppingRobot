...
def navigate_to_node(current_position_name, destination_node_name, request_id):
    ...
    # --- Initial Centering (ONLY when starting from 'home') ---
        if current_position_name == "home"and destination_node_name.startswith("RFJ"):
            ...
            #time.sleep(0.75)  # DELAY INCREASED for initial move.
        else:
    ...
    while True:
        ...
        if esp32.in_waiting > 0:
            ...
            if response.startswith("RFID:"):
                ...
                print(f"looking for uid{expected_uid}")
                ...
                if uid == expected_uid:
                    ...
                    # status_ref.set(f"waiting_for_rfid:{destination_node_name}")  <- MOVED
                    send_command('S')  # Stop
                    ...
                    current_position=destination_node_name#me
                    send_command("F")
                    time.sleep(.05)
        ...
        if turning:
            if turn_direction == 'R':
                ...
                if not left_sensor and center_sensor and not right_sensor: #back to center
                    ...
                    send_command("F") #added forward after turn
...
if __name__ == "__main__":
    ...
    try:
        ...
        lgpio.gpiochip_close(h)  # Clean up lgpio on exitS
