            ...
            if response.startswith("RFID:"):
                ...
                if uid in rfj_uids:
                    ...
                    if destination_node_name.startswith("pdt"):
                        ...
                        turning = True
                        turn_direction = "L"
                        print("Turning LEFT at RFJ for home journey.")
                    ...
                    # ---  Stay forward at RBJ if going to a *different* RBJ---
                ...
                if expected_uid is not None and uid == expected_uid:
                    ...
                    #send_command("F") Don't send "F", let line following decide.
