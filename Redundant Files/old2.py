        ...
        if esp32.in_waiting > 0:
            ...
            if response.startswith("RFID:"):
                ...
                if uid in rfj_uids:
                    ...
                    elif destination_node_name == "home":
                        send_command("R")
                        turning = True
                        turn_direction = "R"
                        print("Turning RIGHT at RFJ to face products (going home).")
                ...
                elif expected_uid is not None and uid != expected_uid: #added and uid != expected_uid
                    print(f"Incorrect RFID. Expected: {expected_uid}, Got: {uid}")
                    # Don't send 'F'. Let line following handle.
